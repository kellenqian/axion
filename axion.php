...
$appIncludePath	= 	//APP_CONTROLLER_PATH.DS.PATH_SEPARATOR.
					APP_MODEL_PATH.DS.PATH_SEPARATOR.
					APP_DISPATCHER_PATH.DS.PATH_SEPARATOR;
/*					
$axionIncludePath = AXION_APPLICATION_PATH.DS.PATH_SEPARATOR.
					AXION_CONTROLLER_PATH.DS.PATH_SEPARATOR.
					AXION_MODEL_PATH.DS.PATH_SEPARATOR.
					AXION_VIEW_PATH.DS.PATH_SEPARATOR.
					AXION_DISPATCHER_PATH.DS.PATH_SEPARATOR.
					AXION_DATABASE_PATH.DS.PATH_SEPARATOR;
*/
					
set_include_path($appIncludePath.$axionIncludePath.$currentIncludePath);

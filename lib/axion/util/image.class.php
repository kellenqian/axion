...
class AXION_UTIL_IMAGE {
	 ...
	 * @return image 转换后的图片
	 */
	public static function imgResize($str_imgSourceName, $int_width = null, $int_height = null) {
		//判断源文件是否存在
	...
	public static function getColor($int_seed, $int_pigment = 0) {
	 ...
	 */
	public static function createPie($arr_paras, $int_width, $int_height = '') {
		//获取图片大小
		if (empty ( $int_height ))

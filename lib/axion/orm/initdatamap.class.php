...
class Axion_orm_InitDataMap {
	...
	public function __construct($str_tableName, $str_keyName = null) {
		...
		$this->arr_billFormat = array (//布尔
		Axion_orm_DataMap::TYPE_BOOLEAN => array ('value' => null, 'type' => Axion_orm_DataMap::TYPE_BOOLEAN, 'defValue' => 0, 'isExpression' => false, 'maxLength' => 1, 'minLength' => 1, 'isNull' => false, 'preg' => '', 'unsigned' => true, 'unique' => false, 'vType' => 'checkbox', 'action' => 'a' ), //数值
		Axion_orm_DataMap::TYPE_INT => array ('value' => null, 'type' => Axion_orm_DataMap::TYPE_INT, 'defValue' => 0, 'isExpression' => true, 'maxLength' => null, 'minLength' => null, 'isNull' => false, 'preg' => '', 'unsigned' => true, 'unique' => false, 'vType' => 'text', 'action' => 'a' ), //浮点
		Axion_orm_DataMap::TYPE_FLOAT => array ('value' => null, 'type' => Axion_orm_DataMap::TYPE_FLOAT, 'defValue' => 0.00, 'isExpression' => true, 'maxLength' => null, 'minLength' => null, 'isNull' => false, 'preg' => '', 'unsigned' => true, 'unique' => false, 'vType' => 'text', 'action' => 'a' ), //字符串
		Axion_orm_DataMap::TYPE_STRING => array ('value' => null, 'type' => Axion_orm_DataMap::TYPE_STRING, 'defValue' => null, 'isExpression' => false, 'maxLength' => 64, 'minLength' => null, 'isNull' => false, 'preg' => '', 'unsigned' => true, 'unique' => false, 'vType' => 'text', 'action' => 'a' ), //邮件地址
		Axion_orm_DataMap::TYPE_MAIL => array ('value' => null, 'type' => Axion_orm_DataMap::TYPE_MAIL, 'defValue' => null, 'isExpression' => false, 'maxLength' => 64, 'minLength' => null, 'isNull' => false, 'preg' => REG_MAIL, 'unsigned' => true, 'unique' => false, 'vType' => 'text', 'action' => 'a' ), //日期
		Axion_orm_DataMap::TYPE_DATE => array ('value' => null, 'type' => Axion_orm_DataMap::TYPE_DATE, 'defValue' => 'CURRENT_TIMESTAMP', 'isExpression' => true, 'maxLength' => 19, 'minLength' => 19, 'isNull' => false, 'preg' => REG_DATETIME, 'unsigned' => true, 'unique' => false, 'vType' => 'text', 'action' => 'a' ) );

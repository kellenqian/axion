<?php
	...
	class Axion_orm_DataSchema {
		...
		/**
		 * 根据参数的验证信息验证指定数据的合法性，并将相关的结果保存到obj_Axion_log中
		 *
		...
		protected function checkParameter( $arr_paraInfo )
		{
			...
			{
				case Axion_orm_DataMap::TYPE_INT :
					return $this->checkInt( $arr_paraInfo );
				
				case Axion_orm_DataMap::TYPE_FLOAT :
					return $this->checkFloat( $arr_paraInfo );
				
				case Axion_orm_DataMap::TYPE_DATE :
					return $this->checkDate( $arr_paraInfo );
				
				case Axion_orm_DataMap::TYPE_MAIL :

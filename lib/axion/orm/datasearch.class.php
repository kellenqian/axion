	...
	{	
		...
		function __construct(  )
		{
			...
			if( !class_exists( $this->str_tableName ) )
			{
				...
				{
					$_obj_initDataMap = new Axtion_orm_InitDataMap( $this->str_tableName );
					$_obj_initDataMap->createFile( "./lib/model/" );
				}
				
				require_once( "./lib/model/{$this->str_tableName}.class.php" );
			}

<?php
	...
	***************************************************/ 
	 ...
	 * @return string
	 */
	function tranNumber( $str_Number, $int_lv = 0 )
	{
		...
		{
			$_str_result = $_arr_numberName[$_arr_subNumber[$_int_i]]
								. ( empty( $_arr_subNumber[$_int_i] ) ? '' : $_arr_numberFormat[$_int_numberLength - $_int_i - 1] )
								. $_str_result;
		}//for
